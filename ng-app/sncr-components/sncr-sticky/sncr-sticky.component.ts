...
@Component({
    selector: 'sncr-sticky,[sncr-sticky]',
    template: '<ng-content></ng-content>',
    styleUrls: ['sncr-sticky.component.scss']
})

export class SncrStickyComponent implements OnInit, AfterViewInit {
